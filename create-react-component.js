...
// API
// nosw create-react-component.js directory componentName
// nosw create-react-component.js atoms Button
// ->
...
const createReactComponent = async (directoryName, componentName) => {
	...
	await mkdir(directory, { recursive: true }); // mehrere:, {recursive: true}
